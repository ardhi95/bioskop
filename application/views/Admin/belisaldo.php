...
<head>
  ...
  <title>Admin Movie Station</title>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Pembelian Saldo Oleh Customer</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example" class="table table table-bordered table-hover">
                <thead>
                <tr>
                ...
                <tr>
                  <td><?=$field->id_transaksi_saldo;?></td>
                  <td><?=$field->tanggal?></td>
                  ...
                  <td><?="Rp ".number_format($field->jumlah_saldo,2,',','.')?></td>
                  <td align="center">
                  <?php
                  if ($field->status == 0) { ?>
                  <a class="twitter" data-title="ACC Transaksi" href="<?= base_url()."Saldo/update?kode=".$this->M_other->encrypt($field->id_transaksi_saldo)."&mail=".$field->email?>"><button type="button" class="btn btn-danger btn-xs"></span> verifikasi</button>
                  <?php }
                  else{
                    echo "Terverifikasi";
                  }
